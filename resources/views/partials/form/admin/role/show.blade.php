...
@section('page-content')
    <div class="form-group">
        ...
        <input type="text" id="name" name="name" class="form-control" placeholder="Name" value="{{ $role->name }}" disabled>
    </div>

    <div class="form-group">
        <label for="guard_name">Guard Name</label>
        <select name="guard_name" id="guard_name" class="choices form-select" disabled>
            <option value="{{ $role->guard_name }}" selected>{{ ucfirst($role->guard_name) }}</option>
        </select>
    </div>
